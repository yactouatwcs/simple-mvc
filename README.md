...
It uses some cool vendors/libraries such as Twig and Grumphp, which is a code quality analyzer.
This template consists of a simple read from database example.
